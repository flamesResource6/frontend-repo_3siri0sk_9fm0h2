        ...
        <div className="grid lg:grid-cols-12 gap-10 items-center">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="lg:col-span-7">
            ...
            <ul className="mt-6 space-y-3 text-gray-700">
              <li className="flex items-start gap-3"><span className="mt-1"><GraduationCap className="h-5 w-5 text-indigo-600"/></span> Graduated with First Class Honors.</li>
              <li className="flex items-start gap-3"><span className="mt-1"><GraduationCap className="h-5 w-5 text-indigo-600"/></span> GPA: 3.75.</li>
            </ul>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6, delay: 0.1 }} className="lg:col-span-5">
            <div className="relative rounded-2xl border border-black/10 p-6 bg-gradient-to-br from-white to-slate-50 shadow-sm">
              <div className="absolute -right-10 -top-10 h-40 w-40 rounded-full bg-indigo-500/10 blur-2xl"/>
              <div className="absolute -left-10 -bottom-10 h-40 w-40 rounded-full bg-fuchsia-500/10 blur-2xl"/>
