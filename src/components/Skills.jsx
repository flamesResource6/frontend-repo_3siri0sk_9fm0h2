...
export default function Skills() {
  return (
    <section id="skills" className="relative py-24">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_left,rgba(168,85,247,0.08),transparent_50%)]" />
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex items-end justify-between mb-10">
          <h2 className="text-3xl font-bold tracking-tight text-white">Core Skills</h2>
          <p className="text-gray-400 max-w-xl">Practical experience with data manipulation, analysis, and modeling to deliver measurable outcomes.</p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {skills.map((s, i) => (
            <motion.div
              ...
              className={`group relative rounded-2xl border border-white/10 bg-gradient-to-b ${s.color} p-6 overflow-hidden backdrop-blur-sm`}
            >
              <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity bg-gradient-to-tr from-white/10 to-transparent" />
